...
export default function GivingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGiftId(initialValues.giftId);
    setActualPrice(initialValues.actualPrice);
    setBuyerId(initialValues.buyerId);
    setGiverIds(initialValues.giverIds);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Giving(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GivingCreateForm")}
      {...rest}
    >
      <TextField
        label="Status"
