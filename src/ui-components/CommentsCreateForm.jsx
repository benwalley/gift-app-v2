...
export default function CommentsCreateForm(props) {
  ...
  const resetStateValues = () => {
    setIsWishlistComment(initialValues.isWishlistComment);
    setPosterId(initialValues.posterId);
    setGroupIds(initialValues.groupIds);
    setCurrentGroupIdsValue("");
    setIsVisibleToOwner(initialValues.isVisibleToOwner);
    setCommentText(initialValues.commentText);
