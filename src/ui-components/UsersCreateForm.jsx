...
export default function UsersCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAuthUsername(initialValues.authUsername);
    setSubuserModeOn(initialValues.subuserModeOn);
    setParentId(initialValues.parentId);
    setNotes(initialValues.notes);
    setIsUser(initialValues.isUser);
    setEditingUsers(initialValues.editingUsers);
